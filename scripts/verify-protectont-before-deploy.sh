...
echo ""
echo "Optional flyer print check (all published flyers → 1 letter page):"
echo "  ./scripts/test-flyer-print-fit.sh"
echo "  ./scripts/test-flyer-print-fit.sh --slug healthcare"
echo ""
