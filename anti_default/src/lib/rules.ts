...
export const LANGUAGE_RULES: LanguageRule[] = [
  ...
  {
    id: "gendered-occupations",
    pattern:
      "\\b(?:policeman|policewoman|fireman|mailman|salesman|congressman|stewardess|waitress|businessman|businesswoman)\\b",
    category: "gender",
    severity: "low",
    label: "Gendered occupation",
