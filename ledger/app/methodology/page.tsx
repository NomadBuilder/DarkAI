              ...
              <div className="space-y-6 md:space-y-8 prose prose-sm md:prose max-w-none">
                <section>
                  ...
                  <p className="text-sm md:text-base text-gray-700 mb-3 md:mb-4 font-light leading-relaxed">
                    ...
                    evidence-driven: it emphasizes source documents, legislative text, and transparent
                    data processing.
                  </p>
                  <p className="text-sm md:text-base text-gray-700 font-light leading-relaxed">
                    Scope includes Ontario&apos;s Public Accounts, relevant legislation (e.g., Bill 5, Bill 60),
                    and credible third-party research. It does not attempt to cover every program or
                    every vendor in the province; the focus is on the largest and most consequential
                    patterns that affect public services.
                  </p>
                </section>
