...
export const metadata = buildHubPageMetadata(
  ...
  'Protect Ontario has very limited funds for Indigenous-led land and water defence campaigns. Tell us about your campaign if you are seeking support.'
)
      ...
      >
        <div className="space-y-4 text-base sm:text-lg">
          <p>
            ...
            Indigenous-led land and water defence campaigns. We cannot support every campaign — but for the right cause, at the
