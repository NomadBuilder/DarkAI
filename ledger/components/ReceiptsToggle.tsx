...
export default function ReceiptsToggle() {
  ...
  return (
    <button
      ...
      className={`px-4 sm:px-5 py-3 sm:py-2.5 md:py-2 text-sm sm:text-base rounded-lg shadow-sm transition-all duration-300 active:scale-95 touch-manipulation min-h-[44px] sm:min-h-0 ${
        receiptsMode
