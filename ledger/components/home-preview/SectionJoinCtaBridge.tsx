...
import SectionJoinPathBridge from './SectionJoinPathBridge'

/** After the data story — repeat join paths before sources */
export default function SectionJoinCtaBridge() {
  return (
    <div className="border-t border-slate-100">
      <div className="bg-gradient-to-b from-slate-900 to-slate-800 px-4 py-12 text-center sm:px-6 sm:py-14 md:px-8">
        <motion.p
      ...
      <SectionJoinPathBridge variant="compact" />
    </div>
  )
}
