...
export const defaultGetInvolvedFormCopy = (): GetInvolvedFormCopy => ({
  ...
  successBody:
    'We received your sign-up and sent a confirmation email. Please check your inbox (and junk/spam). Tap “I’m still interested” in that email if you can — a volunteer will follow up when we can match you locally.',
  consentText:
