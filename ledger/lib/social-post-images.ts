...
export const ISSUE_RESOURCE_LINKS: Record<FordIssue, { href: string; label: string }> = {
  ...
  greenbelt: { href: '/greenbelt', label: 'Greenbelt' },
  'public-land': { href: '/public-land', label: 'Public land' },
  water: { href: '/water', label: 'Water' },
  transparency: { href: '/receipts', label: 'The Receipts' },
  accountability: { href: '/flyers', label: 'Printable flyers' },
}
