...
export const defaultFlyerEntries: Flyer[] = [
  ...
  },
  {
    ...
    calloutBody:
      'Tell your MPP you want public dollars in public hospitals — protectont.ca/take-action. Find a rally: protectont.ca/protests. Request a sign or volunteer: protectont.ca/join. Full healthcare data: protectont.ca/healthcare',
    published: true,
  },
  {
    id: 'water',
    ...
    calloutBody:
      'Interactive analysis, legislation links, and sources at protectont.ca/water · Contact your MPP at protectont.ca/take-action',
    published: true,
  },
  {
    id: 'public-land',
    ...
    calloutBody:
      'Timelines, sources, and land policy context: protectont.ca/public-land and protectont.ca/receipts · protectont.ca/greenbelt',
    published: true,
  },
  {
    id: 'wildlife',
    ...
    calloutBody:
      'Sign petitions linked at protectont.ca/take-action · Ontario Nature & David Suzuki Foundation campaigns · Share this flyer',
    published: true,
  },
  {
    ...
    calloutBody:
      'protectont.ca/indigenous-rights · protectont.ca/join · protectont.ca/take-action',
    published: true,
  },
  {
    id: 'accountability',
    ...
    calloutBody:
      'protectont.ca · protectont.ca/methodology · protectont.ca/receipts — print this flyer, post it, talk about it.',
    published: true,
  },
  {
    id: 'yard-sign',
    ...
    calloutBody:
      'protectont.ca/products · protectont.ca/join · protectont.ca/protests — put a sign up before the next rally.',
    published: true,
  },
  {
    ...
    calloutBody:
      'Ford Failed You yard sign — $10 with stand · protectont.ca/products · Download artwork on the product page',
    published: true,
  },
  {
    id: 'yard-sign-rally',
    ...
    calloutBody:
      'protectont.ca/protests · protectont.ca/join · Order the yard sign at protectont.ca/products',
    published: true,
  },
]
